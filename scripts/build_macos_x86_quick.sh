...
cd releases
./torchless-0.1.0-macos-x86_64 ../models/DeepSeek-R1-Distill-Llama-8B-f16.gguf --chat --system "You are a helpful assistant. But you do not hold back if you need to say I am wrong or tell me off."
